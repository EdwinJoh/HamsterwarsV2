...
namespace Service;
/// <summary>
/// THis service layers sends request to the repository layer to get the hamsters from the database and return it
/// so the service layer can return it to the requester.
/// </summary>
